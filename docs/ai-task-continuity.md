...
- **Current task**: License control plane shell T017.
- **Status**: Completed.
- **Next task**: T018, complete the LMS application shell and navigation behavior.
- **Blocker**: API health runtime smoke check remains pending; database/auth/provider decisions remain open.
- **Files in focus**: `docs/task-dashboard.html`, `docs/PROJECT_MEMORY.md`, `docs/ai-task-continuity.md`, `specs/001-lms-multi-branch/tasks.md`.\n- **Verification**: Lint/format/typecheck pass; 25 Vitest tests and 9 Chromium E2E tests pass; platform shell and mobile layout are isolated from LMS navigation.
