...
- **Status**: Completed.
- **Current task**: Identity/access schema T025 completed; remote lock/history display completed.
...
- **Files in focus**: `docs/task-dashboard.html`, `docs/PROJECT_MEMORY.md`, `docs/ai-task-continuity.md`, `specs/001-lms-multi-branch/tasks.md`.\n- **Verification**: Drizzle generated 10-table schema and migration 0001; 36 Vitest tests pass; lint/typecheck pass; workspace lock/history transitions recorded. Demo web moved to port 3100 and `/ui-preview` returns HTTP 200.
