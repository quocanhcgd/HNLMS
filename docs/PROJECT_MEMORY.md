...
- Tasks: `T001` to `T175`; T001-T081 are complete; T082 is the next open task.
- Current baseline: Phase 11 has started; T081 assessment schema/migration foundation is complete and T082 assessment policy/service logic is next.
