...
- Tasks: `T001` to `T119` are complete; T120 is the next open task.
- Current baseline: Phase 17 / US14 is complete; T120 Phase 18 reporting read models are next.
...
- 2026-08-22: Completed Phase 20 T131-T136 by adding tenant registry/provisioning/migration schema, isolation/quota service, SaaS-to-dedicated preflight/cutover, migration worker, platform migration UI and tenant isolation/E2E tests; all typechecks and full 374-test Vitest pass.
...
- 2026-08-22: Completed Phase 15 / US12 T101-T106 by adding HRM employee/contract/schedule/leave/review/teacher assignment schema, lifecycle/leave/substitute service, admin HRM and teacher portals, authorization and E2E coverage; all typechecks and full 366-test Vitest pass.
...
- 2026-08-22: Completed Phase 12 / US9 T087-T089 by adding four-skill English placement/progress/manual review service, student/teacher English pathway UIs, integration test and US9 Playwright E2E.
- 2026-08-22: Completed T086 by adding English pathway, level, skill record and placement rule Drizzle entities plus migration 0013; API typecheck passes.
