...
export default function TeacherClassesPage() {
  ...
  return <div className="page">
    ...
    <Stack><UiDataTable table={table} columnCount={columns.length} minWidth={1180} emptyTitle="Không tìm thấy lớp được phân công." /><Text size="xs" c="dimmed">{table.getRowModel().rows.length}/{classes.length} lớp · dữ liệu mẫu teacher workspace</Text></Stack>
